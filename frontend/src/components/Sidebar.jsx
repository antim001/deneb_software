...
const Sidebar = () => {
  ...
  return (
    <div className='flex isMenuActive '>
        ...
        <ul className='pt-2'>
          {Menus.map((menu, index) => (
            <div key={index}>
              ...
              > 
              <NavLink to={menu.path} className={`flex items-center gap-x-4 text-base font-medium flex-1 ${!open && "hidden"}`}>
              ...
              {menu.submenu && menu.submenuOpen && open && (
                <ul>
                  {menu.submenuItems.map((subMenuItem, subIndex) => (
                    ...
                    >
                      <NavLink to={subMenuItem.path}>{subMenuItem.title}</NavLink>
                    </li>
                  ))}
                </ul>
              )}
